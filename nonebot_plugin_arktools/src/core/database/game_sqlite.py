...
class BuildingBuffModel(Model):
    ...
    class Meta:
        table = "building_buff"
'''
class CharWordModel(Model):
    """台词"""
    charWordId = fields.CharField(null=True,max_length=255)
    wordKey = fields.CharField(null=True,max_length=255)
    charId = fields.CharField(null=True,max_length=255)
    voiceId = fields.CharField(null=True,max_length=255)
    voiceText = fields.CharField(null=True,max_length=255)
    voiceTitle = fields.CharField(null=True,max_length=255)
    voiceIndex = fields.IntField(null=True)
    voiceType = fields.CharField(null=True,max_length=255)
    unlockType = fields.CharField(null=True,max_length=255)
    unlockParam = fields.JSONField(null=True)
    lockDescription = fields.CharField(null=True,max_length=255)
    placeType = fields.CharField(null=True,max_length=255)
    voiceAsset = fields.CharField(null=True,max_length=255)
...
class EquipModel(Model):
    ...
    unlockFavors = fields.JSONField(null=True)
    ...
    uniEquipShowEnd = fields.IntField(null=True)
    hasUnlockMission = fields.BooleanField(null=True)
    isSpecialEquip = fields.BooleanField(null=True)
    specialEquipDesc = fields.CharField(null=True, max_length=255)
    specialEquipColor = fields.CharField(null=True, max_length=255)
    charColor = fields.CharField(null=True, max_length=255)
...
class HandbookStageModel(Model):
    ...
    description = fields.CharField(null=True, max_length=300)
    unlockParam = fields.JSONField(null=True)
...
class GachaPoolModel(Model):
    ...
    freeBackColor = fields.CharField(null=True, max_length=255)
    ...
    limitParam = fields.CharField(null=True, max_length=255)
